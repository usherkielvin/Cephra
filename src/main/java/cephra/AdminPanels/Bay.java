...
public class Bay extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        quebutton.addActionListener(this::quebuttonActionPerformed);
        add(quebutton);
        ...
        businessbutton.addActionListener(this::businessbuttonActionPerformed);
        add(businessbutton);
        ...
        exitlogin.addActionListener(this::exitloginActionPerformed);
        add(exitlogin);
