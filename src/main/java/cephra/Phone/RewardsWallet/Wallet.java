...
public class Wallet extends javax.swing.JPanel {
    ...
    public Wallet() {
        ...
        SwingUtilities.invokeLater(() -> {
            if (cephra.Phone.Popups.Pending_Payment.hasPendingPayPop()) {
                cephra.Phone.Popups.Pending_Payment.restorePayPopAfterTopUp();
            }
    ...
    private void loadWalletData() {
        try {
            ...
            if (currentUser != null && !currentUser.isEmpty()) {
                ...
                balance = (float) cephra.Database.CephraDB.getUserWalletBalance(currentUser);
                updateBalanceDisplay();
