...
public class ChargeOption extends javax.swing.JPanel {
    public ChargeOption() {
        initComponents();
    ...
    private void makeDraggable() {
        ...
        addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                if (dragPoint[0] != null) {
                    java.awt.Window window = SwingUtilities.getWindowAncestor(ChargeOption.this);
                    if (window != null) {
    ...
    private void exitloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitloginActionPerformed
        java.awt.Window w = javax.swing.SwingUtilities.getWindowAncestor(ChargeOption.this);
